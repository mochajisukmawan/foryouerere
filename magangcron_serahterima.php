...
curl_setopt($ch, CURLOPT_URL,"http://magang.bankjateng.co.id/sync/magang_serah_trima");
...
$server_output = $server_output. " Sync Serah Terima src: magangcron_serahterima ".date("Y-m-d H:i:s")."\n";
