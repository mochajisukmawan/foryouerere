...
<form method="post" action="<?=base_url()?>user/lkd2post" class="form-horizontal">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control auto_numformat" name="pajak_restribusi" required=""  value="<?=number_format($dataLkd2['pajak_restribusi'],0,',','.')?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="belanja_rumah_tangga" type="text" class="form-control auto_numformat pengeluaran" name="belanja_rumah_tangga" required=""  value="<?=number_format($dataLkd2['belanja_rumah_tangga'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Sewa Kontrak/Rumah</label>
                            <div class="col-sm-9">
                                <input id="sewa" type="text" class="form-control auto_numformat pengeluaran" name="sewa" required="" value="<?=number_format($dataLkd2['sewa_kontrak_rumah'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Pendidikan</label>
                            <div class="col-sm-9">
                                <input id="pendidikan" type="text" class="form-control auto_numformat pengeluaran" name="pendidikan" required="" value="<?=number_format($dataLkd2['pendidikan'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Telpon, Listrik & Air</label>
                            <div class="col-sm-9">
                                <input id="telpon_listrik_air" type="text" class="form-control auto_numformat pengeluaran" name="biaya_telpon_listrik_air" required="" value="<?=number_format($dataLkd2['biaya_telpon_listrik_air'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Transportasi</label>
                            <div class="col-sm-9">
                                <input id="transportasi" type="text" class="form-control auto_numformat pengeluaran" name="biaya_transportasi" required="" value="<?=number_format($dataLkd2['biaya_transportasi'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Pengeluaran Lainnya</label>
                            <div class="col-sm-9">
                                <input id="pengeluaran_lainnya" type="text" class="form-control auto_numformat pengeluaran" name="pengeluaran_lainnya" required="" value="<?=number_format($dataLkd2['pengeluaran_lainnya'],0,',','.')?>">
                            </div>
                        </div> 
                        <div class="form-group">
                ...
                <div class="panel-body">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="sum_persediaan_inventory" type="text" class="form-control auto_numformat dohcalculate" name="sum_persediaan_inventory" required=""  value="<?=number_format($dataLkd1Sum['sum_persediaan_inventory'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Piutang Dagang </label>
                            <div class="col-sm-9">
                                <input id="sum_piutang_dagang" type="text" class="form-control auto_numformat dohcalculate" name="sum_piutang_dagang" required=""  value="<?=number_format($dataLkd1Sum['sum_piutang_dagang'],0,',','.')?>">
                            </div>
                        </div>    
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Utang Dagang </label>
                            <div class="col-sm-9">
                                <input id="sum_utang_dagang" type="text" class="form-control auto_numformat dohcalculate" name="sum_utang_dagang" required=""  value="<?=number_format($dataLkd1Sum['sum_utang_dagang'],0,',','.')?>">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="perputaran_persediaan_dagang" type="text" class="form-control dohcalculate" name="perputaran_persediaan_dagang" required=""  value="<?=$dataLkd2['perputaran_persediaan_barang']?>">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="panel-body">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="rekomendasi_nilai_kredit" type="text" class="form-control auto_numformat calcrekomendasi" name="rekomendasi_nilai_kredit" required=""  value="<?=$dataLkd2['rekomendasi_nilai_kredit']?>">
                            </div>
                        </div>    
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Jangka Waktu Kredit (Bulan)</label>
                            <div class="col-sm-9">
                                <input id="jangka_waktu_kredit" type="text" class="form-control " name="jangka_waktu_kredit" required=""  value="<?=$dataLkd2['jangka_waktu_kredit']?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="eff" type="number" class="form-control calcrekomendasi" name="eff" required="" step="0.0001"  value="<?=$dataLkd2['eff']?>">
                            </div>
                        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <button type="submit" class="btn btn-primary" onclick="return confirm('Update Data?');" value="revisi">Update Data</button>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function updateAnalisaKeuangan(){
        ...
        $("#disposable_income").val(numberWithCommas(disposable_income));
        updateGrossProfit();
    }
    ...
    function updateRekomendasiAngsuran(){
        ...
        var calcangsuran = (numPlafond*(numEff/100)/12) / ( 1 - Math.pow(1 + (numEff/100/12),-numJangka));
        ...
        if(effective=='Menurun'){
            ...
            calcangsuran = (numPlafond*(numEff/100)/12) / ( 1 - Math.pow(1 + (numEff/100/12),(numJangka* -1)));
        }
        var calcbungabulan = (((calcangsuran * numJangka) - numPlafond )/ (numJangka/12) / numPlafond ) / 12;
        calcbungabulan=calcbungabulan*100;
        //Dalam %
        var calc2 = parseFloat(((numAngsuranSaatIni+calcangsuran)/disposable_income)*100); 
        // alert(calc2);
        $("#rekomendasi_angsuran_kredit").val(Math.round(calcangsuran));
        $("#idir").val((calc2.toFixed(2)));
        $("#bunga_per_bulan").val((calcbungabulan.toFixed(2)));
