<div class="row">
<form id="form" action="<?=base_url()?>user/savefasilitaskreditbl/<?=$dn_id?>"  method="post" enctype="multipart/form-data">
    ...
    <div class="hpanel">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <input type="text" value="" class="status2 form-control" name="status2" >

            </div>
                <div class="text-right m-t-xs">
                    <button type="hidden" class="btn btn-success">Save</button>
                </div>
        </div>
    </div>
    </div>
