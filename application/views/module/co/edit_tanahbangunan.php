<div class="row">
<form id="form" action="<?=base_url()?>user/updatetanahbangunan/<?=$dn_id?>/<?=$id_tb?>"  method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-lg-4 ">
                    ...
                    <input type="date" value="<?=$tanahbangunan->tanggal_pemeriksaan?>" class="form-control" name="tanggal_pemeriksaan" >
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="bentuk_bangunan"]').val('<?=$tanahbangunan->bentuk_bangunan?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="kondisi_bangunan"]').val('<?=$tanahbangunan->kondisi_bangunan?>');
                    </script>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <label>score</label>
                        <input type="text" value="<?=$tanahbangunan->score_tanah?>" class="form-control" name="score_tanah" readonly>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="lebar_jalan_depan_jaminan">
                        ...
                        foreach($ljdj as $v_ljdj){
                            if($v_ljdj->id_ljdj == $tanahbangunan->lebar_jalan_depan_jaminan) {
                            ?>
                                <option value="<?=$v_ljdj->score_ljdj?>||&$!#%||<?=$v_ljdj->id_ljdj?>" selected><?=$v_ljdj->nama_ljdj?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="lebar_tanah_yang_menghadap_ke_jalan">
                        ...
                        <?php
                            if($v_ltymkj->id_ltymkj == $tanahbangunan->lebar_tanah_yang_menghadap_ke_jalan) {
                            ?>
                                <option value="<?=$v_ltymkj->score_ltymkj?>||&$!#%||<?=$v_ltymkj->id_ltymkj ?>" selected><?=$v_ltymkj->nama_ltymkj?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="letak_tanah_jaminan">
                        ...
                        <?php
                            if($v_ltj->id_ltj == $tanahbangunan->letak_tanah_jaminan) {
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="bentuk_tanah">
                        ...
                        foreach($bt as $v_bt){?>
                        <?php
                            if($v_bt->id_bt == $tanahbangunan->bentuk_tanah) {
                            ?>
                                <option value="<?=$v_bt->score_bt?>||&$!#%||<?=$v_bt->id_bt?>" selected><?=$v_bt->nama_bt?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="kondisi_jalan_di_depan_jaminan">
                        ...
                        <?php
                            if($v_kjdj->id_kjdj == $tanahbangunan->kondisi_jalan_di_depan_jaminan) {
                            ?>
                ...
                <div class="form-group col-lg-8">
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="faktor_pengurang_tanah_1">
                        ...
                        <?php
                            if($v_fpt->id_fpt == $tanahbangunan->faktor_pengurang_tanah_1) {
                            ?>
                                <option value="<?=$v_fpt->score_fpt?>||&$!#%||<?=$v_fpt->id_fpt?>" selected><?=$v_fpt->nama_fpt?></option>
                            <?php
                            }else{
                            ?>
                    ...
                    <select type="text"  value="" class="form-control form-score-tanah" name="faktor_pengurang_tanah_2">
                        ...
                        foreach($fpt as $v_fpt){?>
                        <?php
                            if($v_fpt->id_fpt == $tanahbangunan->faktor_pengurang_tanah_2) {
                            ?>
                                <option value="<?=$v_fpt->score_fpt?>||&$!#%||<?=$v_fpt->id_fpt?>" selected><?=$v_fpt->nama_fpt?></option>
                            <?php
                            }else{
                    ...
                    <select type="text" value="" class="form-control form-score-tanah" name="faktor_pengurang_tanah_3">
                        ...
                        foreach($fpt as $v_fpt){?>
                        <?php
                            if($v_fpt->id_fpt == $tanahbangunan->faktor_pengurang_tanah_3) {
                            ?>
                                <option value="<?=$v_fpt->score_fpt?>||&$!#%||<?=$v_fpt->id_fpt?>" selected><?=$v_fpt->nama_fpt?></option>
                            <?php
                            }else{
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <label>score</label>
                        <input type="text" value="<?=$tanahbangunan->score_tanah?>" class="form-control" name="score_bangunan" readonly>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="pondasi">
                        ...
                        <?php
                            if($v_pondasi->id_pondasi == $tanahbangunan->pondasi) {
                            ?>
                                <option value="<?=$v_pondasi->score_pondasi?>||&$!#%||<?=$v_pondasi->id_pondasi?>" selected><?=$v_pondasi->nama_pondasi?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="lantai">
                        ...
                        <?php
                            if($v_lantai->id_lantai == $tanahbangunan->lantai) {
                            ?>
                                <option value="<?=$v_lantai->score_lantai?>||&$!#%||<?=$v_lantai->id_lantai?>" selected><?=$v_lantai->nama_lantai?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="bangunan_tingkat">
                        ...
                        foreach($bt as $v_bt){?>
                        <?php
                            if($v_bt->id_bt == $tanahbangunan->bangunan_tingkat) {
                            ?>
                                <option value="<?=$v_bt->score_bt?>||&$!#%||<?=$v_bt->id_bt?>" selected><?=$v_bt->nama_bt?></option>
                            <?php
                            }else{
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="usia_bangunan">
                        ...
                        foreach($ub as $v_ub){?>
                        <?php
                            if($v_ub->id_ub == $tanahbangunan->usia_bangunan) {
                            ?>
                                <option value="<?=$v_ub->score_ub?>||&$!#%||<?=$v_ub->id_ub?>" selected><?=$v_ub->nama_ub?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="dinding">
                        ...
                        <?php
                            if($v_dinding->id_dinding == $tanahbangunan->dinding) {
                            ?>
                                <option value="<?=$v_dinding->score_dinding?>||&$!#%||<?=$v_dinding->id_dinding?>" selected><?=$v_dinding->nama_dinding?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="kamar_mandi">
                        ...
                        foreach($km as $v_km){?>
                        <?php
                            if($v_km->id_km == $tanahbangunan->kamar_mandi) {
                            ?>
                                <option value="<?=$v_km->score_km?>||&$!#%||<?=$v_km->id_km?>" selected><?=$v_km->nama_km?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="atap">
                        ...
                        <?php
                            if($v_atap->id_atap == $tanahbangunan->atap) {
                            ?>
                                <option value="<?=$v_atap->score_atap?>||&$!#%||<?=$v_atap->id_atap?>" selected><?=$v_atap->nama_atap?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="plafond">
                        ...
                        <?php
                            if($v_plafond->id_plafond == $tanahbangunan->plafond) {
                            ?>
                                <option value="<?=$v_plafond->score_plafond?>||&$!#%||<?=$v_plafond->id_plafond?>" selected><?=$v_plafond->nama_plafond?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="jaringan_listrik">
                        ...
                        foreach($jl as $v_jl){?>
                        <?php
                            if($v_jl->id_jl == $tanahbangunan->jaringan_listrik) {
                            ?>
                                <option value="<?=$v_jl->score_jl?>||&$!#%||<?=$v_jl->id_jl?>" selected><?=$v_jl->nama_jl?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" value="<?=$tanahbangunan->tegangan_listrik?>" class="auto_numformat form-control" name="tegangan_listrik" >
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="perawatan"]').val('<?=$tanahbangunan->perawatan?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <select type="text" value="" class="form-control form-score-bangunan" name="sumber_air">
                        ...
                        foreach($sa as $v_sa){?>
                        <?php
                            if($v_sa->id_sa == $tanahbangunan->sumber_air) {
                            ?>
                                <option value="<?=$v_sa->score_sa?>||&$!#%||<?=$v_sa->id_sa?>" selected><?=$v_sa->nama_sa?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-8">
                    ...
                    <select type="text"  value="" class="form-control form-score-bangunan" name="faktor_pengurang_bangunan_1">
                        ...
                        <?php
                            if($v_fpb->id_fpb == $tanahbangunan->faktor_pengurang_bangunan_1) {
                            ?>
                                <option value="<?=$v_fpb->score_fpb?>||&$!#%||<?=$v_fpb->id_fpb?>" selected><?=$v_fpb->nama_fpb?></option>
                            <?php
                            }else{
                            ?>
                    ...
                    <select type="text"  value="" class="form-control form-score-bangunan" name="faktor_pengurang_bangunan_2">
                        ...
                        foreach($fpb as $v_fpb){?>
                        <?php
                            if($v_fpb->id_fpb == $tanahbangunan->faktor_pengurang_bangunan_2) {
                            ?>
                                <option value="<?=$v_fpb->score_fpb?>||&$!#%||<?=$v_fpb->id_fpb?>" selected><?=$v_fpb->nama_fpb?></option>
                            <?php
                            }else{
                    ...
                    <select type="text"  value="" class="form-control form-score-bangunan" name="faktor_pengurang_bangunan_3">
                        ...
                        foreach($fpb as $v_fpb){?>
                        <?php
                            if($v_fpb->id_fpb == $tanahbangunan->faktor_pengurang_bangunan_3) {
                            ?>
                                <option value="<?=$v_fpb->score_fpb?>||&$!#%||<?=$v_fpb->id_fpb?>" selected><?=$v_fpb->nama_fpb?></option>
                            <?php
                            }else{
                ...
                <div class="form-group col-lg-4">
                    ...
                    <script>
                        $('[name="telepon"]').val('<?=$tanahbangunan->telepon?>');
                    </script>
                </div>
                <div class="form-group col-lg-4">
                    <label>No Telepon</label>
                    <input type="text" value="<?=$tanahbangunan->no_telepon?>" class="form-control" name="no_telepon" >

                </div>

                <div class="form-group col-lg-12">
                    <label>Alamat jaminan</label>
                    <input type="text" value="<?=$tanahbangunan->alamat_jaminan?>" class="form-control" name="alamat_jaminan" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Kelurahan & Kecamatan</label>
                    <input type="text" value="<?=$tanahbangunan->kelurahan_kecamatan?>" class="form-control" name="kelurahan_kecamatan" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Wilayah Kota</label>
                    <input type="text" value="<?=$tanahbangunan->wilayah_kota?>" class="form-control" name="wilayah_kota" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Nama Pemegang Hak</label>
                    <input type="text" value="<?=$tanahbangunan->nama_pemegang_hak?>" class="form-control" name="nama_pemegang_hak" >
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="hubungan_pemegang_hak_dengan_nasabah"]').val('<?=$tanahbangunan->hubungan_pemegang_hak_dengan_nasabah?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    <label>Nama Penghuni</label>
                    <input type="text" value="<?=$tanahbangunan->nama_penghuni?>" class="form-control" name="nama_penghuni" >
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="status_penghuni"]').val('<?=$tanahbangunan->status_penghuni?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="hubungan_penghuni_dengan_pemegang_hak"]').val('<?=$tanahbangunan->hubungan_penghuni_dengan_pemegang_hak?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="jenis_dokumen"]').val('<?=$tanahbangunan->jenis_dokumen?>');
                    </script>
                </div>
                <div class="form-group col-lg-4">
                    <label>No Bukti Hak</label>
                    <input type="text" value="<?=$tanahbangunan->no_bukti_hak?>" class="form-control" name="no_bukti_hak" >
                </div>
                <div class="form-group col-lg-4">
                    <label>No GS</label>
                    <input type="text" value="<?=$tanahbangunan->no_gs?>" class="form-control" name="no_gs" >
                </div>
                <div class="form-group col-lg-4">
                    <label>Tgl Jatuh Tempo Sertifikat</label>
                    <input type="date" value="<?=$tanahbangunan->tgl_jatuh_tempo_sertifikat?>" class="form-control" name="tgl_jatuh_tempo_sertifikat" >
                </div>
                <div class="form-group col-lg-12">
                <table id="datamonitor" class="table table-bordered table-responsive">
					...
					<tbody>
                        <tr>
							...
							<td><input type="text" value="<?=$tanahbangunan->luas_tanah_m2?>" class="auto_numformat form-control luas_tanah_m2" name="luas_tanah_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->harga_tanah_m2?>" class="auto_numformat form-control harga_tanah_m2" name="harga_tanah_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->nilai_market_tanah?>" class="auto_numformat form-control nilai_market_tanah" name="nilai_market_tanah" readonly></td>
							<td colspan="2 "></td>
						</tr>
                        <tr>
							<td><label>Luas Bangunan (1)</label></td>
							<td><input type="text" value="<?=$tanahbangunan->luas_bangunan_1_m2?>" class="auto_numformat form-control luas_bangunan_1_m2" name="luas_bangunan_1_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->harga_bangunan_1_m2?>" class="auto_numformat form-control harga_bangunan_1_m2" name="harga_bangunan_1_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->nilai_market_bangunan_1?>" class="auto_numformat form-control nilai_market_bangunan_1" name="nilai_market_bangunan_1" readonly></td>
							...
							<td>                    
                                ...
                                <script>
                                    $('[name="ibm_bangunan_1"]').val('<?=$tanahbangunan->ibm_bangunan_1?>');
                                </script>
                            </td>
						</tr>
                        <tr>
							<td><label>Luas Bangunan (2)</label></td>
							<td><input type="text" value="<?=$tanahbangunan->luas_bangunan_2_m2?>" class="auto_numformat form-control luas_bangunan_2_m2" name="luas_bangunan_2_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->harga_bangunan_2_m2?>" class="auto_numformat form-control harga_bangunan_2_m2" name="harga_bangunan_2_m2" ></td>
							<td><input type="text" value="<?=$tanahbangunan->nilai_market_bangunan_2?>" class="auto_numformat form-control nilai_market_bangunan_2" name="nilai_market_bangunan_2" readonly></td>
							<td><label>IMB</label></td>
							<td>                    
                                ...
                                <script>
                                    $('[name="ibm_bangunan_2"]').val('<?=$tanahbangunan->ibm_bangunan_2?>');
                                </script>
                            </td>						
                        </tr>
                        <tr>
							<td colspan="3"><label>Total</label></td>
							<td><input type="text" value="<?=$tanahbangunan->total_market?>" class="auto_numformat form-control total_market" name="total_market" readonly></td>
							<td><label>LTV</label></td>
							<td>                    
							    <input type="text" value="<?=$tanahbangunan->ltv?>" class="form-control ltv" name="ltv" readonly>
                            </td>						
                        </tr>
					</tbody>
				</table>
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" value="<?=$tanahbangunan->nama_info_harga_1?>" class="form-control" name="nama_info_harga_1" >
                </div>
                <div class="form-group col-lg-8">
                    <label>Alamat/ No. Tlp, jika ada</label>
                    <input type="text" value="<?=$tanahbangunan->detail_info_harga_1?>" class="form-control" name="detail_info_harga_1" >
                </div>
                <div class="form-group col-lg-4">
                    <input type="text" value="<?=$tanahbangunan->nama_info_harga_2?>" class="form-control" name="nama_info_harga_2" >
                </div>
                <div class="form-group col-lg-8">
                    <input type="text" value="<?=$tanahbangunan->detail_info_harga_2?>" class="form-control" name="detail_info_harga_2" >
                </div>
                ...
                <div class="form-group col-lg-4">
                    ...
                    <script>
                        $('[name="cek_bpn"]').val('<?=$tanahbangunan->cek_bpn?>');
                    </script>
                </div>
                <div class="form-group col-lg-4">
                    <label>Dengan Siapa</label>
                    <input type="text" value="<?=$tanahbangunan->dengan_siapa_cek_bpn?>" class="form-control" name="dengan_siapa_cek_bpn" >
                </div>
                <div class="form-group col-lg-4">
                    <label>No. Telpon</label>
                    <input type="text" value="<?=$tanahbangunan->no_telp_cek_bpn?>" class="form-control" name="no_telp_cek_bpn" >
                </div>
                <div class="form-group col-lg-4">
                    <label>Hasil</label>
                    ...
                    <script>
                        $('[name="hasil_cek_bpn"]').val('<?=$tanahbangunan->hasil_cek_bpn?>');
                    </script>
                </div>
                <div class="form-group">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <textarea type="text" class="form-control" name="tentang_harga" ><?=$tanahbangunan->tentang_harga?></textarea>
                </div>
                <div class="form-group col-lg-12">
                    <label>2. Kondisi Lingkungan Sekitar</label>
                    <textarea type="text" class="form-control" name="kondisi_lingkungan_sekitar" ><?=$tanahbangunan->kondisi_lingkungan_sekitar?></textarea>
                </div>
                <div class="form-group col-lg-12">
                    <label>3. Peruntukan Tanah</label>
                    <input type="text" value="<?=$tanahbangunan->peruntukan_tanah?>" class="form-control" name="peruntukan_tanah" >
                </div>
                <div class="form-group col-lg-3">
                    <label>4. Lebar Jalan Di Depan (meter) </label>
                    <input type="text" value="<?=$tanahbangunan->lebar_jalan_di_depan?>" class="form-control" name="lebar_jalan_di_depan" >
                </div>
                <div class="form-group col-lg-12">
                    <label>5. Pendapat Pemeriksa Mengenai Kondisi Jaminan</label>
                    <textarea type="text" class="form-control" name="pendapat_pemeriksa_mengenai_kondisi_jaminan" ><?=$tanahbangunan->pendapat_pemeriksa_mengenai_kondisi_jaminan?></textarea>
                </div>
