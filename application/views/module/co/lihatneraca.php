            ...
            <div class="hpanel">
                <div class="panel-body">
                    <table class="table table-bordered" style="text-align: center;">
                        ...
                        <tr>
                            <td>Kas</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="kas" readonly value="<?=number_format($dataNeraca['kas'],0,',','.')?>"></td>
                        </tr>
                        <tr>
                            <td>Tabungan dan Deposito</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="tabungan_deposito" readonly value="<?=number_format($dataNeraca['tabungan_deposito'],0,',','.')?>"></td>
                        </tr>
                        <tr>
                            <td>Investasi Lainnya</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="investasi_lainnya" readonly value="<?=number_format($dataNeraca['investasi_lainnya'],0,',','.')?>"></td>
                        </tr>
                        <tr>
                            <td>Piutang</td>
                         ...
                         <tr>
                            ...
                            <td><input type="text" class="form-control auto_numformat addaset" name="uang_muka_dibayar" readonly value="<?=number_format($dataNeraca['uang_muka_dibayar'],0,',','.')?>"></td>
                        </tr>
                         <tr>
                            <td>Tanah dan Gedung</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="tanah_gedung" readonly value="<?=number_format($dataNeraca['tanah_gedung'],0,',','.')?>"></td>
                        </tr>
                         <tr>
                            <td>Mesin dan Peralatan Kerja</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="mesin_peralatan" readonly value="<?=number_format($dataNeraca['mesin_peralatan'],0,',','.')?>"></td>
                        </tr>
                         <tr>
                            <td>Kendaraan</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="kendaraan" readonly value="<?=number_format($dataNeraca['kendaraan'],0,',','.')?>"></td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                            <td>Aset lainnya</td>
                            <td><input type="text" class="form-control auto_numformat addaset" name="aset_lainya" readonly value="<?=number_format($dataNeraca['aset_lainya'],0,',','.')?>"></td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control auto_numformat addkewajiban" name="hitung_jangka_pendek" readonly value="<?=number_format($dataNeraca['hitung_jangka_pendek'],0,',','.')?>"></td>
                        </tr>
                        <tr>
                            <td>Hutang Jangka Panjang</td>
                            <td><input type="text" class="form-control auto_numformat addkewajiban" name="hitung_jangka_panjang" readonly value="<?=number_format($dataNeraca['hitung_jangka_panjang'],0,',','.')?>"></td>
                        </tr>
                        <tr>
