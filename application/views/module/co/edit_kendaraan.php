<div class="row">
<form id="form" action="<?=base_url()?>user/updatekendaraan/<?=$dn_id?>/<?=$id_kendaraan?>"  method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-lg-4 ">
                    ...
                    <input type="date" value="<?=$kendaraan->tanggal_pemeriksaan?>" class="form-control" name="tanggal_pemeriksaan" >
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="jenis_kendaraan"]').val('<?=$kendaraan->jenis_kendaraan?>');
                    </script>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="penggunaan_jaminan_kendaraan"]').val('<?=$kendaraan->penggunaan_jaminan_kendaraan?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    ...
                    <script>
                        $('[name="daerah_operasional_jaminan_dari_lokasi_usaha"]').val('<?=$kendaraan->daerah_operasional_jaminan_dari_lokasi_usaha?>');
                    </script>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <label>score</label>
                        <input type="text" value="<?=$kendaraan->score_kendaraan?>" class="form-control" name="score_kendaraan" readonly>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="umur_kendaraan">
                        ...
                        foreach($uk as $v_uk){?>
                        <?php
                            if($v_uk->id_uk == $kendaraan->umur_kendaraan) {
                            ?>
                                <option value="<?=$v_uk->score_uk?>||&$!#%||<?=$v_uk->id_uk ?>" selected><?=$v_uk->nama_uk?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="jarak_tempuh">
                        ...
                        foreach($jt as $v_jt){?>
                        <?php
                            if($v_jt->id_jt == $kendaraan->jarak_tempuh) {
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="asal_merk_kendaraan">
                        ...
                        foreach($mk as $v_mk){?>
                        <?php
                            if($v_mk->id_mk == $kendaraan->asal_merk_kendaraan) {
                            ?>
                                <option value="<?=$v_mk->score_mk?>||&$!#%||<?=$v_mk->id_mk?>" selected><?=$v_mk->nama_mk?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="kondisi_fisik">
                        ...
                        foreach($kf as $v_kf){?>
                        <?php
                            if($v_kf->id_kf == $kendaraan->kondisi_fisik) {
                            ?>
                                <option value="<?=$v_kf->score_kf?>||&$!#%||<?=$v_kf->id_kf?>" selected><?=$v_kf->nama_kf?></option>
                            <?php
                            }else{
                            ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="kapasitas_mesin">
                        ...
                        foreach($km as $v_km){?>
                        <?php
                            if($v_km->id_km == $kendaraan->kapasitas_mesin) {
                            ?>
                ...
                <div class="form-group col-lg-8">
                    ...
                    <select type="text"    value="" class="form-control form-score-kendaraan" name="faktor_pengurang_kendaraan_1">
                        ...
                        <?php
                            if($v_fpk->id_fpk == $kendaraan->faktor_pengurang_kendaraan_1) {
                            ?>
                                <option value="<?=$v_fpk->score_fpk?>||&$!#%||<?=$v_fpk->id_fpk?>" selected><?=$v_fpk->nama_fpk?></option>
                            <?php
                            }else{
                            ?>
                    ...
                    <select type="text"   value="" class="form-control form-score-kendaraan" name="faktor_pengurang_kendaraan_2">
                        ...
                        foreach($fpk as $v_fpk){?>
                        <?php
                            if($v_fpk->id_fpk == $kendaraan->faktor_pengurang_kendaraan_2) {
                            ?>
                                <option value="<?=$v_fpk->score_fpk?>||&$!#%||<?=$v_fpk->id_fpk?>" selected><?=$v_fpk->nama_fpk?></option>
                            <?php
                            }else{
                ...
                <div class="form-group col-lg-12 ">
                    ...
                    <input type="text" value="<?=$kendaraan->nama_pemilik_di_bpkb?>" class="form-control" name="nama_pemilik_di_bpkb" >
                </div>
                <div class="form-group col-lg-12 ">
                    <label>Nama Pemilik Saat Ini (Berdasarkan Kuitansi Jual Beli Terakhir)</label>
                    <input type="text" value="<?=$kendaraan->nama_pemilik_saat_ini?>" class="form-control" name="nama_pemilik_saat_ini" >
                </div>
                <div class="form-group col-lg-12 ">
                    <label>Alamat Pemilik Saat Ini (Berdasarkan Kuitansi Jual Beli Terakhir)</label>
                    <input type="text" value="<?=$kendaraan->alamat_pemilik_saat_ini?>" class="form-control" name="alamat_pemilik_saat_ini" >
                </div>
                ...
                <div class="form-group col-lg-8">
                    ...
                    <script>
                        $('[name="hubungan_pemilik_dengan_debitur"]').val('<?=$kendaraan->hubungan_pemilik_dengan_debitur?>');
                    </script>
                </div>

                <div class="form-group col-lg-8">
                    <label>Nomor Faktur</label>
                    <input type="text" value="<?=$kendaraan->nomor_faktur?>" class="form-control" name="nomor_faktur" >
                </div>
                <div class="form-group col-lg-8">
                    <label>Nomor Mesin</label>
                    <input type="text" value="<?=$kendaraan->nomor_mesin?>" class="form-control" name="nomor_mesin" >
                </div>
                <div class="form-group col-lg-4">
                    ...
                    <script>
                        $('[name="bukti_gesek_mesin"]').val('<?=$kendaraan->bukti_gesek_mesin?>');
                    </script>
                </div>
                <div class="form-group col-lg-8">
                    <label>Nomor Rangka</label>
                    <input type="text" value="<?=$kendaraan->nomor_rangka?>" class="form-control" name="nomor_rangka" >
                </div>
                <div class="form-group col-lg-4">
                    <label>Bukti Gesek</label>
                    ...
                    <script>
                        $('[name="bukti_gesek_rangka"]').val('<?=$kendaraan->bukti_gesek_rangka?>');
                    </script>
                </div>
                <div class="form-group col-lg-6">
                    <label>Nomor Polisi</label>
                    <input type="text" value="<?=$kendaraan->nomor_polisi?>" class="form-control" name="nomor_polisi" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Warna</label>
                    <input type="text" value="<?=$kendaraan->warna?>" class="form-control" name="warna" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Nomor BPKB</label>
                    <input type="text" value="<?=$kendaraan->nomor_bpkb?>" class="form-control" name="nomor_bpkb" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Tahun Pembuatan</label>
                    <input type="text" value="<?=$kendaraan->tahun_pembuatan?>" class="form-control" name="tahun_pembuatan" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Nomor STNK</label>
                    <input type="text" value="<?=$kendaraan->nomor_stnk?>" class="form-control" name="nomor_stnk" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Merk Kendaraan</label>
                    <input type="text" value="<?=$kendaraan->merk_kendaraan?>" class="form-control" name="merk_kendaraan" >
                </div>
                <div class="form-group col-lg-10">
                    <label>Tipe Kendaraan/ Model</label>
                    <input type="text" value="<?=$kendaraan->tipe_kendaraan?>" class="form-control" name="tipe_kendaraan" >
                </div>
                <div class="form-group col-lg-4">
                    ...
                    <script>
                        $('[name="check_samsat"]').val('<?=$kendaraan->check_samsat?>');
                    </script>
                </div>
                <div class="form-group col-lg-4">
                    <label>Dengan Siapa</label>
                    <input type="text" value="<?=$kendaraan->denga_siapa?>" class="form-control" name="denga_siapa" >
                </div>
                <div class="form-group col-lg-4">
                    <label>No. Telpon</label>
                    <input type="text" value="<?=$kendaraan->no_telpon?>" class="form-control" name="no_telpon" >
                </div>
                <div class="form-group col-lg-4">
                    <label>Hasil</label>
                    ...
                    <script>
                        $('[name="hasil"]').val('<?=$kendaraan->hasil?>');
                    </script>
                </div>
                <div class="form-group col-lg-12">
                    <label>Keterangan lainnya</label>
                    <textarea class="form-control" name="keterangan_lainnya" ><?=$kendaraan->keterangan_lainnya?></textarea>
                </div>
                <div class="form-group col-lg-12">
                <table id="datamonitor" class="table table-bordered table-responsive">
					...
					<tbody>
                        <tr>
							<td><input type="text" value="<?=$kendaraan->harga_kendaraan?>" class="auto_numformat form-control harga_kendaraan" name="harga_kendaraan" ></td>
							<td><input type="text" value="<?=$kendaraan->nilai_market_kendaraan?>" class="auto_numformat form-control nilai_market_kendaraan" name="nilai_market_kendaraan" readonly></td>
							<td colspan="2 "><input type="text" value="<?=$kendaraan->nilai_taksasi?>" class="auto_numformat form-control nilai_taksasi" name="nilai_taksasi" readonly></td>
						</tr>
                        ...
                        <tr>
							...
							<td>                    
							    <input type="text" value="<?=$kendaraan->ltv?>" class="form-control ltv" name="ltv" readonly>
                            </td>						
                        </tr>
					</tbody>
				</table>
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="text" value="<?=$kendaraan->nama_info_harga_1?>" class="form-control" name="nama_info_harga_1" >
                </div>
                <div class="form-group col-lg-8">
                    <label>Alamat/ No. Tlp, jika ada</label>
                    <input type="text" value="<?=$kendaraan->detail_info_harga_1?>" class="form-control" name="detail_info_harga_1" >
                </div>
                <div class="form-group col-lg-4">
                    <input type="text" value="<?=$kendaraan->nama_info_harga_2?>" class="form-control" name="nama_info_harga_2" >
                </div>
                <div class="form-group col-lg-8">
                    <input type="text" value="<?=$kendaraan->detail_info_harga_2?>" class="form-control" name="detail_info_harga_2" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Pendapat Pemeriksa Mengenai Kondisi Jaminan</label>
                    <textarea type="text" class="form-control" name="pendapat_pemeriksa_mengenai_kondisi_jaminan" ><?=$kendaraan->pendapat_pemeriksa_mengenai_kondisi_jaminan?></textarea>
                </div>
