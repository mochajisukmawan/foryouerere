                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="telpon_listrik_air" type="text" class="form-control auto_numformat pengeluaran" name="telpon_listrik_air" required="" readonly value="<?=number_format($dataLkd2['biaya_telpon_listrik_air'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Transportasi</label>
                            <div class="col-sm-9">
                                <input id="transportasi" type="text" class="form-control auto_numformat pengeluaran" name="transportasi" required="" readonly value="<?=number_format($dataLkd2['biaya_transportasi'],0,',','.')?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Pengeluaran Lainnya</label>
...
<script type="text/javascript">
    ...
    function updateRekomendasiAngsuran(){
        ...
        var calc2 = parseFloat((numAngsuranSaatIni+calcangsuran)/disposable_income); 
        // alert(calc2);
