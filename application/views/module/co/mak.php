            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>No MAK</td>
                        <td>
                            <input type="text" class="form-control" name="no_mak" value="" >
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal Input</td>
                        <td>
                            <input type="text" class="form-control" name="tgl_input_mak"  value="<?=date("Y-m-d H:i:s")?>" readonly>
                        </td>
                    </tr>
        ...
        <div class="hpanel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Simpan Data?');" value="revisi">Simpan Data</button>
                    </div>
                </div>
            </div>
        </div>
