<div class="row">
<form id="form" action="<?=base_url()?>user/savekios/<?=$dn_id?>"  method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <label>score</label>
                        <input type="text" value="" class="form-control" name="score_kios" readonly>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" value="" class="form-control" name="dok_bukti_hak_kios" >
                </div>
                <div class="form-group col-lg-6">
                    <label>No Dokumen</label>
                    <input type="text" value="" class="form-control" name="no_dokumen" >
                </div>
                <div class="form-group col-lg-6">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input type="date" value="" class="form-control" name="masa_berlaku_mulai" >
                </div>
                <div class="form-group col-lg-4">
                    <label>s/d</label>
                    <input type="date" value="" class="form-control" name="masa_berlaku_akhir" >
                </div>

                <div class="form-group col-lg-4">
                    <label>Luas Kios Berdasarkan Bukti Kepemilikn (m2)</label>
                    <input type="text" value="" class="form-control" name="luas_kios_berdasarkan_bukti_kepemilikan" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Nama Pasar</label>
                    <input type="text" value="" class="form-control" name="nama_pasar" >
                </div>
                <div class="form-group col-lg-4">
                    <label>Los/Blok</label>
                    <input type="text" value="" class="form-control" name="los" >
                </div>
                <div class="form-group col-lg-4">
                    <label>No</label>
                    <input type="text" value="" class="form-control" name="no_kios" >
                </div>
                <div class="form-group col-lg-12">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" value="" class="form-control" name="tahun_pasar_bangun_renovasi" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Retribusi per Bulan (Rp.)</label>
                    <input type="text" value="" class="form-control" name="retribusi_perbulan" >
                </div>
                <div class="form-group col-lg-6">
                    <label>Litrik</label>
                ...
                <table id="datamonitor" class="table table-bordered table-responsive">
					...
					<tbody>
                        <tr>
							<td><input type="text" value="" class="auto_numformat form-control harga_kios" name="harga_kios" ></td>
							<td><input type="text" value="" class="auto_numformat form-control nilai_market_kios" name="nilai_market_kios" readonly></td>
