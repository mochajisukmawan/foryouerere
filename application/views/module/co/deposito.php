<div class="row">
<form id="form" action="<?=base_url()?>user/savedeposito/<?=$dn_id?>"  method="post" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" value="" class="form-control" name="nama_pemilik" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Alamat Pemilik</label>
                    <input type="text" value="" class="form-control" name="alamat_pemilik" >
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <input type="text" value="" class="form-control" name="nomor_bilyet" >
                </div>
                <div class="form-group col-lg-12">
                    <label>Bank & Cabang Penerbit</label>
                    <input type="text" value="" class="form-control" name="bank_cabang_penerbit" >
                </div>
                
                <div class="form-group col-lg-4">
                    <label>Tanggal Penerbitan</label>
                    <input type="date" value="" class="form-control" name="tgl_penerbitan">
                </div>

                <div class="form-group col-lg-4">
                    <label>Tanggal jatuh Tempo</label>
                    <input type="date" value="" class="form-control" name="tgl_jatuh_tempo">
                </div>
                <div class="form-group col-lg-4">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" value="" class="auto_numformat form-control nilai_nominal" name="nilai_nominal">
                </div>
                <div class="form-group col-lg-6">
                    <label>Nilai Taksasi</label>
                    <input type="text" value="" class="auto_numformat form-control" name="nilai_taksasi" readonly>
                </div>
                <div class="form-group col-lg-6">
                    <label>Nilai Nominal (Valuta Asing)</label>
                    <input type="text" value="" class="auto_numformat form-control" name="nilai_nominal_asing">
                </div>

                <div class="form-group col-lg-6">
                    <label>Nilai Tukar (Rp.)</label>
                    <input type="text" value="" class="auto_numformat form-control" name="nilai_tukar">
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <textarea type="text" class="form-control" name="pendapat_pemeriksa" ></textarea>
                </div>
            </div>
