...
<form method="post" action="<?=base_url()?>user/lkd2post" class="form-horizontal">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="telpon_listrik_air" type="text" class="form-control auto_numformat pengeluaran" name="biaya_telpon_listrik_air" required="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Transportasi</label>
                            <div class="col-sm-9">
                                <input id="transportasi" type="text" class="form-control auto_numformat pengeluaran" name="biaya_transportasi" required="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Pengeluaran Lainnya</label>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <button type="submit" class="btn btn-primary" onclick="return confirm('Kirim Data?');" value="baru">Kirim Data</button>
        </div>
    </div>
</form>
