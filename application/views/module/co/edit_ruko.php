<form id="form" action="<?=base_url()?>user/updateruko/<?=$dn_id?>/<?=$id_ruko?>"  method="post" enctype="multipart/form-data"><div class="row">
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <label>score</label>
                                <input type="text" value="<?=$ruko->score_penggolongan?>" class="form-control" name="score_penggolongan" readonly>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="lokasi_ruko">
                                    ...
                                    foreach($lr as $v_lr){?>
                                    <?php
                                        if($v_lr->id_lr == $ruko->lokasi_ruko) {
                                        ?>
                                            <option value="<?=$v_lr->score_lr?>||&$!#%||<?=$v_lr->id_lr?>" selected><?=$v_lr->nama_lr?></option>
                                        <?php
                                        }else{
                                        ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="fungsionalitas">
                                    ...
                                    <?php
                                        if($v_fungsionalitas->id_fungsionalitas == $ruko->fungsionalitas) {
                                        ?>
                                            <option value="<?=$v_fungsionalitas->score_fungsionalitas?>||&$!#%||<?=$v_fungsionalitas->id_fungsionalitas ?>" selected><?=$v_fungsionalitas->nama_fungsionalitas?></option>
                                        <?php
                                        }else{
                                        ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="area_jaminan">
                                    ...
                                    foreach($aj as $v_aj){?>
                                    <?php
                                        if($v_aj->id_aj == $ruko->area_jaminan) {
                                        ?>
                                            <option value="<?=$v_aj->score_aj?>||&$!#%||<?=$v_aj->id_aj ?>" selected><?=$v_aj->nama_aj?></option>
                                        <?php
                                        }else{
                                        ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="bangunan_ruko">
                                    ...
                                    foreach($br as $v_br){?>
                                    <?php
                                        if($v_br->id_br == $ruko->bangunan_ruko) {
                                        ?>
                                            <option value="<?=$v_br->score_br?>||&$!#%||<?=$v_br->id_br ?>" selected><?=$v_br->nama_br?></option>
                                        <?php
                                        }else{
                                        ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="fasilitas_parkir_umum">
                                    ...
                                    <?php
                                        if($v_fpu->id_fpu == $ruko->fasilitas_parkir_umum) {
                                        ?>
                                            <option value="<?=$v_fpu->score_fpu?>||&$!#%||<?=$v_fpu->id_fpu ?>" selected><?=$v_fpu->nama_fpu?></option>
                                        <?php
                                        }else{
                                        ?>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" value="" class="form-control form-score-penggolongan" name="imb">
                                    ...
                                    <?php
                                        if($v_imb->id_imb == $ruko->imb) {
                                        ?>
                                            <option value="<?=$v_imb->score_imb?>||&$!#%||<?=$v_imb->id_imb ?>" selected><?=$v_imb->nama_imb?></option>
                                        <?php
                                        }else{
                                        ?>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 ">
                            ...
                            <input type="date" value="<?=$ruko->tanggal_pemeriksaan?>" class="form-control" name="tanggal_pemeriksaan" >
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <script>
                                $('[name="bentuk_bangunan"]').val('<?=$ruko->bentuk_bangunan?>');
                            </script>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <label>score</label>
                                <input type="text" value="<?=$ruko->score_ruko?>" class="form-control" name="score_ruko" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="lebar_jalan_di_depan_komp_ruko">
                                ...
                                <?php
                                    if($v_ljdkr->id_ljdkr == $ruko->lebar_jalan_di_depan_komp_ruko) {
                                    ?>
                                        <option value="<?=$v_ljdkr->score_ljdkr?>||&$!#%||<?=$v_ljdkr->id_ljdkr?>" selected><?=$v_ljdkr->nama_ljdkr?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="lebar_bangunan_ruko">
                                ...
                                <?php
                                    if($v_lbr->id_lbr == $ruko->lebar_bangunan_ruko) {
                                    ?>
                                        <option value="<?=$v_lbr->score_lbr?>||&$!#%||<?=$v_lbr->id_lbr ?>" selected><?=$v_lbr->nama_lbr?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="jalan_di_depan_komp_ruko">
                                ...
                                <?php
                                    if($v_jdkr->id_jdkr == $ruko->jalan_di_depan_komp_ruko) {
                                    ?>
                                        <option value="<?=$v_jdkr->score_jdkr?>||&$!#%||<?=$v_jdkr->id_jdkr?>" selected><?=$v_jdkr->nama_jdkr?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="akses_umum">
                                ...
                                foreach($au as $v_au){?>
                                <?php
                                    if($v_au->id_au == $ruko->akses_umum) {
                                    ?>
                                        <option value="<?=$v_au->score_au?>||&$!#%||<?=$v_au->id_au?>" selected><?=$v_au->nama_au?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="letak_tanah_bangunan_ruko">
                                ...
                                <?php
                                    if($v_ltbr->id_ltbr == $ruko->letak_tanah_bangunan_ruko) {
                                    ?>
                                        <option value="<?=$v_ltbr->score_ltbr?>||&$!#%||<?=$v_ltbr->id_ltbr?>" selected><?=$v_ltbr->nama_ltbr?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="lokasi_ruko_dari_arah_pintu_masuk_jalan_utama">
                                ...
                                <?php
                                    if($v_lrdapmju->id_lrdapmju == $ruko->lokasi_ruko_dari_arah_pintu_masuk_jalan_utama) {
                                    ?>
                                        <option value="<?=$v_lrdapmju->score_lrdapmju?>||&$!#%||<?=$v_lrdapmju->id_lrdapmju?>" selected><?=$v_lrdapmju->nama_lrdapmju?></option>
                                    <?php
                                    }else{
                                    ?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="lantai_ruko">
                                ...
                                foreach($lr as $v_lr){?>
                                <?php
                                    if($v_lr->id_lr == $ruko->lantai_ruko) {
                                    ?>
                                        <option value="<?=$v_lr->score_lr?>||&$!#%||<?=$v_lr->id_lr?>" selected><?=$v_lr->nama_lr?></option>
                                    <?php
                                    }else{
                        ...
                        <div class="form-group col-lg-8">
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="faktor_pengurang_ruko_1">
                                ...
                                <?php
                                    if($v_fpr->id_fpr == $ruko->faktor_pengurang_ruko_1) {
                                    ?>
                                        <option value="<?=$v_fpr->score_fpr?>||&$!#%||<?=$v_fpr->id_fpr?>" selected><?=$v_fpr->nama_fpr?></option>
                                    <?php
                                    }else{
                                    ?>
                            ...
                            <select type="text"  value="" class="form-control form-score-ruko" name="faktor_pengurang_ruko_2">
                                ...
                                foreach($fpr as $v_fpr){?>
                                <?php
                                    if($v_fpr->id_fpr == $ruko->faktor_pengurang_ruko_2) {
                                    ?>
                                        <option value="<?=$v_fpr->score_fpr?>||&$!#%||<?=$v_fpr->id_fpr?>" selected><?=$v_fpr->nama_fpr?></option>
                                    <?php
                                    }else{
                            ...
                            <select type="text" value="" class="form-control form-score-ruko" name="faktor_pengurang_ruko_3">
                                ...
                                foreach($fpr as $v_fpr){?>
                                <?php
                                    if($v_fpr->id_fpr == $ruko->faktor_pengurang_ruko_3) {
                                    ?>
                                        <option value="<?=$v_fpr->score_fpr?>||&$!#%||<?=$v_fpr->id_fpr?>" selected><?=$v_fpr->nama_fpr?></option>
                                    <?php
                                    }else{
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <script>
                                $('[name="telepon"]').val('<?=$ruko->telepon?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-4">
                            <label>No Telepon</label>
                            <input type="text" value="<?=$ruko->no_telepon?>" class="form-control" name="no_telepon" >

                        </div>

                        <div class="form-group col-lg-12">
                            <label>Alamat jaminan</label>
                            <input type="text" value="<?=$ruko->alamat_jaminan?>" class="form-control" name="alamat_jaminan" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Kelurahan & Kecamatan</label>
                            <input type="text" value="<?=$ruko->kelurahan_kecamatan?>" class="form-control" name="kelurahan_kecamatan" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Wilayah Kota</label>
                            <input type="text" value="<?=$ruko->wilayah_kota?>" class="form-control" name="wilayah_kota" >
                        </div>
                        <div class="form-group col-lg-6">
                            <label>Nama Pemegang Hak</label>
                            <input type="text" value="<?=$ruko->nama_pemegang_hak?>" class="form-control" name="nama_pemegang_hak" >
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <script>
                                $('[name="hubungan_pemegang_hak_dengan_nasabah"]').val('<?=$ruko->hubungan_pemegang_hak_dengan_nasabah?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-6">
                            <label>Nama Penghuni</label>
                            <input type="text" value="<?=$ruko->nama_penghuni?>" class="form-control" name="nama_penghuni" >
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <script>
                                $('[name="status_penghuni"]').val('<?=$ruko->status_penghuni?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <script>
                                $('[name="hubungan_penghuni_dengan_pemegang_hak"]').val('<?=$ruko->hubungan_penghuni_dengan_pemegang_hak?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <script>
                                $('[name="jenis_dokumen"]').val('<?=$ruko->jenis_dokumen?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-4">
                            <label>No Bukti Hak</label>
                            <input type="text" value="<?=$ruko->no_bukti_hak?>" class="form-control" name="no_bukti_hak" >
                        </div>
                        <div class="form-group col-lg-4">
                            <label>No GS</label>
                            <input type="text" value="<?=$ruko->no_gs?>" class="form-control" name="no_gs" >
                        </div>
                        <div class="form-group col-lg-4">
                            <label>Tgl Jatuh Tempo Sertifikat</label>
                            <input type="date" value="<?=$ruko->tgl_jatuh_tempo_sertifikat?>" class="form-control" name="tgl_jatuh_tempo_sertifikat" >
                        </div>
                        <div class="form-group col-lg-12">
                        <table id="datamonitor" class="table table-bordered table-responsive">
                            <thead>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" value="<?=$ruko->luas_ruko?>" class="auto_numformat form-control luas_ruko" name="luas_ruko" ></td>
                                    <td><input type="text" value="<?=$ruko->harga_ruko?>" class="auto_numformat form-control harga_ruko" name="harga_ruko" ></td>
                                    <td><input type="text" value="<?=$ruko->nilai_market_ruko?>" class="auto_numformat form-control nilai_market_ruko" name="nilai_market_ruko" readonly></td>
                                    <td colspan="2 "><input type="text" value="<?=$ruko->nilai_taksasi?>" class="auto_numformat form-control nilai_taksasi" name="nilai_taksasi" readonly></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>                    
                                        <input type="text" value="<?=$ruko->ltv?>" class="form-control ltv" name="ltv" readonly>
                                    </td>						
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" value="<?=$ruko->nama_info_harga_1?>" class="form-control" name="nama_info_harga_1" >
                        </div>
                        <div class="form-group col-lg-8">
                            <label>Alamat/ No. Tlp, jika ada</label>
                            <input type="text" value="<?=$ruko->detail_info_harga_1?>" class="form-control" name="detail_info_harga_1" >
                        </div>
                        <div class="form-group col-lg-4">
                            <input type="text" value="<?=$ruko->nama_info_harga_2?>" class="form-control" name="nama_info_harga_2" >
                        </div>
                        <div class="form-group col-lg-8">
                            <input type="text" value="<?=$ruko->detail_info_harga_2?>" class="form-control" name="detail_info_harga_2" >
                        </div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <script>
                                $('[name="cek_bpn"]').val('<?=$ruko->cek_bpn?>');
                            </script>
                        </div>
                        <div class="form-group col-lg-4">
                            <label>Dengan Siapa</label>
                            <input type="text" value="<?=$ruko->dengan_siapa_cek_bpn?>" class="form-control" name="dengan_siapa_cek_bpn" >
                        </div>
                        <div class="form-group col-lg-4">
                            <label>No. Telpon</label>
                            <input type="text" value="<?=$ruko->no_telp_cek_bpn?>" class="form-control" name="no_telp_cek_bpn" >
                        </div>
                        <div class="form-group col-lg-4">
                            <label>Hasil</label>
                            ...
                            <script>
                                $('[name="hasil_cek_bpn"]').val('<?=$ruko->hasil_cek_bpn?>');
                            </script>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea type="text" class="form-control" name="tentang_harga" ><?=$ruko->tentang_harga?></textarea>
                        </div>
                        <div class="form-group col-lg-12">
                            <label>2. Kondisi Lingkungan Sekitar</label>
                            <textarea type="text" class="form-control" name="kondisi_lingkungan_sekitar" ><?=$ruko->kondisi_lingkungan_sekitar?></textarea>
                        </div>
                        <div class="form-group col-lg-12">
                            <label>3. Peruntukan Tanah</label>
                            <input type="text" value="<?=$ruko->peruntukan_tanah?>" class="form-control" name="peruntukan_tanah" >
                        </div>
                        <div class="form-group col-lg-3">
                            <label>4. Lebar Jalan Di Depan (meter) </label>
                            <input type="text" value="<?=$ruko->lebar_jalan_di_depan?>" class="form-control" name="lebar_jalan_di_depan" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>5. Pendapat Pemeriksa Mengenai Kondisi Jaminan</label>
                            <textarea type="text" class="form-control" name="pendapat_pemeriksa_mengenai_kondisi_jaminan" ><?=$ruko->pendapat_pemeriksa_mengenai_kondisi_jaminan?></textarea>
                        </div>
