...
<form method="post" action="<?=base_url()?>user/lkd3post" class="form-horizontal">
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama_orang_ditemui" readonly value="<?=$dataLkd4['nama_orang_ditemui']?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="lama_berhubungan" required=""><?=$dataLkd4['lama_hubungan']?></textarea>
                            </div>
                        </div>    
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="karakter_pemohon">
                                    <option value="<?=$dataLkd4['karakter_pemohon']?>"><?=$key['karakter_pemohon']?></option>
                                </select>
                            </div>
                        </div>    
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="pengelolaan_usaha">
                                    <option value="<?=$dataLkd4['pengelolaan_usaha']?>"><?=$key['pengelolaan_usaha']?></option>
                                </select>
                            </div>
                        </div>    
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="no_telp" value="<?=$dataLkd4['no_telp']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Tujuan Kredit</label>
                            <div class="col-sm-9">
                                <select class="form-control" name="tujuan_kredit" readonly>
                                        <option value="<?=$dataLkd4['tujuan_kredit']?>"><?=$key['nama_tp']?></option>
                                </select>
                            </div>
                        </div> 
    ...
    <div class="col-lg-12">
        <div class="hpanel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <textarea class="form-control" rows="8" name="penjelasan"><?=$dataLkd4['penjelasan']?></textarea>
                </div>
