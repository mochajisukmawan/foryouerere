                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" value=""  class="auto_numformat form-control" name="nilai_kredit"  >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Jangka waktu Kredit (Bulan)</label>
                            <input type="text" value="" onkeyup="angka(this);"  class="form-control" name="waktu_kredit"   maxlengthlength="3">
                        </div>
                        <div class="form-group col-lg-12">
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            <label>No KTP</label>
                            <input type="text" value="" onkeyup="angka(this);"  class="form-control" name="no_ktp" >
                        </div>
                        <div class="form-group col-lg-12">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" value=""  maxlength="3" onkeyup="angka(this);" class="form-control" name="jml_tanggungan" >
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="hpanel">
                ...
                <div class="row">
                    <div class="form-group col-lg-12">
                        ...
                        <div class="form-group col-lg-12">
                            <label>RT</label>
                            <input type="text" value=""  onkeyup="angka(this);"  maxlength="3"  class="form-control" name="rt" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>RW</label>
                            <input type="text" value="" onkeyup="angka(this);"  maxlength="3"  class="form-control" name="rw" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Kode Pos</label>
                            <input type="text" value="" onkeyup="angka(this);"  maxlength="9"   class="form-control" name="kode_pos" >
                        </div>
                        <div class="form-group col-lg-12">
                        ...
                        <div class="form-group col-lg-12">
                            <label>Lama Menempati (Tahun)</label>
                            <input type="text" value=""  onkeyup="angka(this);"  maxlength="3"  class="form-control" name="lama_menempati" >
                        </div>
                        <div class="form-group col-lg-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" value="" onkeyup="angka(this);" class="form-control" name="jumlah_dibiayai" >
                        </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" value="" onkeyup="angka(this);"  maxlength="4" class="form-control" name="sejak_tahun" >
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Saldo Rata-rata</label>
                            <input type="text" value="" class="auto_numformat form-control" name="saldo_rata" >
                        </div>
...
$( document ).ready(function() {
    ...
    $.ajax({
            ...
            $('[name="nilai_kredit"]').val(numberWithCommas(response[0].nilai_kredit));
            ...
            $('[name="jumlah_dibiayai"]').val(response[0].jumlah_dibiayai);

            $('[name="cpu"]').val(response[0].cpu);
            $('[name="fcpu"]').val(response[0].fcpu);
            $('[name="rekening_tabungan"]').val(response[0].rekening_tabungan);
            $('[name="sejak_tahun"]').val(response[0].sejak_tahun);
            $('[name="saldo_rata"]').val(numberWithCommas(response[0].saldo_rata));

            $('[name="tgl_submit"]').val(response[0].tgl_submit);
            $('[name="no_aplikasi"]').val(response[0].no_aplikasi);
            $('[name="unit_area"]').val(response[0].unit_area);
            $('[name="kode_marketing"]').val(response[0].kode_marketing);
            $('[name="nama_marketing"]').val(response[0].nama_marketing);
            $('[name="perkenalan_terjadi"]').val(response[0].perkenalan_terjadi);

            $('[name="nama_emergency"]').val(response[0].nama_emergency);
            $('[name="alamat_emergency"]').val(response[0].alamat_emergency);
            $('[name="no_hp_emergency"]').val(response[0].no_hp_emergency);
            $('[name="hubungan_emergency"]').val(response[0].hubungan_emergency);
...
function cek_usia(){
    ...
    $("input,select").change(function(){
        ...
        nilai_kredit = $('[name="nilai_kredit"]').val().split('.').join('');
        waktu_kredit = $('[name="waktu_kredit"]').val();
        ...
        saldo_rata = $('[name="saldo_rata"]').val().split('.').join('');
